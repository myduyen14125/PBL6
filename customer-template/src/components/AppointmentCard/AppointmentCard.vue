<template>
  <div class="appointment-card bg-slate-50 w-fit relative p-3 rounded-lg hover:shadow-md">
    <div class="appointment-card__header">
      <div class="appointment-card__header">
        <div class="appointment-card__header__title">
          <h4 class="font-bold text-xl">Lịch hẹn tư vấn nghề nghiệp</h4>
          <p class="text-gray-500 text-md">20/10/2021</p>
          <div class="appointment-card__header__status bg-yellow-500 w-fit px-2 rounded absolute right-3 top-12">
            <span class="text-white text-sm">Đang xử lý</span>
          </div>
        </div>
      </div>
    </div>
    <div class="appointment-card__body mt-3">
      <div class="appointment-card__body__top flex flex-col items-center text-center">
        <div class="appointment-card__body__top__avatar">
          <img src="https://picsum.photos/200/300" alt="avatar" class="w-20 h-20 rounded-full" />
        </div>
        <div class="appointment-card__body__top__info mt-2">
          <h4 class="font-bold text-xl m-0">Nguyễn Văn A</h4>
