  ...
  <div class="h-100 position-relative">
    ...
    <div class="content">
      <div class="d-flex align-items-center mb-2">
        ...
        <h1 v-if="activity.title" class="title w-60 break-word white-space">
          {{ activity.title.trim() }}
        </h1>
      </div>
      <ul>
...
export default {
  ...
  methods: {
    ...
    markPublic() {
      this.$api.activity.markPublicActivity(this.activity.id).then((res) => {
