    ...
    <div class="content">
      ...
      <ul>
        <li class="list-item px-4 py-2 d-flex min-h-48">
          ...
          <div v-if="application.full_name" class="content-desc">
        ...
        <li class="list-item px-4 py-2 d-flex h-48">
          ...
          <div class="content-desc">
            {{ getPositionName(application.position_id) }}
          </div>
        </li>
...
export default {
  ...
  methods: {
    ...
    changeStatus(status) {
      if (status === "TODO") {
        this.$api.application
          .markDoingApplication(this.$route.params.id)
          .then((res) => {
        ...
        this.$api.application
          .markDoneApplication(this.$route.params.id)
          .then((res) => {
