    ...
    <div class="content">
     <ul>
        <li class="list-item px-3 py-2 d-flex">
          ...
          <div v-if="subject.title" class="content-desc">{{ subject.title.trim() }}</div>
        </li>
        <li class="list-item px-3 py-2 d-flex">
        ...
        <li class="list-item px-3 py-2 d-flex">
          ...
          <div class="content-desc">{{ formatDateTime(subject.created_at) }}</div>
        </li>
      </ul>
...
export default {
  ...
  methods: {
    ...
    removeItem(id) {
      this.$api.contactSubject.deleteSubject(id)
        .then((res) => {
