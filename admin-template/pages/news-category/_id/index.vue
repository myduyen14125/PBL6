  ...
  <div class="h-100 position-relative">
    <div class="header d-flex justify-content-between">
      <div class="d-flex align-items-center">
        ...
        <h1 class="title">News category detail</h1>
      </div>
    </div>
    <hr class="my-2">
    <div class="content">
     <ul>
        <li class="list-item px-3 py-2 d-flex">
          ...
          <div v-if="category.title" class="content-desc category">{{ category.title.trim() }}</div>
        </li>
        <li class="list-item px-3 py-2 d-flex">
    ...
    <BaseModal
      ...
      :description="'Do you want to delete this News Category?'"
...
export default {
  ...
  methods: {
    ...
    removeItem(id) {
      this.$api.newsCategory.deleteNewsCate(id)
        .then((res) => {
