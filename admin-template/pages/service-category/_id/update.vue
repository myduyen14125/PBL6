  ...
  <div class="h-100 position-relative">
    <div class="table-header d-flex align-items-center">
      <div class="d-flex align-items-center">
        ...
        <h1 class="title">Update service category</h1>
      </div>
    </div>
    <hr class="my-2">
    <FormSubItem 
    ...
    <BaseModal
      ...
      :description="'Do you want to update this service category?'"
      :function-text="'Update'"
      @function-action="updateCategory"
      @close="closeModal"
    >
    </BaseModal>
  </div>
...
export default {
  ...
  methods: {
    ...
    updateCategory(category) {
      this.$api.serviceCategory.updateCategory(this.category.id, this.category)
        .then((res) => {
          this.$toast.success('Update successfully!', {
            className: 'my-toast',
          })
          this.$router.push('/service-category/' + this.category.id)
        })
        .catch(() => {
