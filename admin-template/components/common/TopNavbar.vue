<template>
  <header class="bg-white">
    <client-only>
      <div
        class="
          navbar-wrapper mx-4 pl-2 w-100
          d-flex
      ...
      >
        <div class="left-nav d-flex">
          <div class="logo">
            <div v-if="!isToggleNavbar">
              <img src="~/assets/images/logo-it.png" alt="logo" height="100px"/>
              <img class="ml-35px cursor-pointer" src="~/assets/icons/chevron-left.svg" @click="toggleNavbar">
            </div>
            <div v-else>
              <img src="~/assets/images/logo/icon-logo.png" alt="logo" height="70px"/>
              <img class="ml-1 cursor-pointer" src="~/assets/icons/chevron-right.svg" @click="toggleNavbar">
            </div>  
        ...
        <div class="right-nav d-flex align-items-center position-relative">
          <div v-if="$auth.loggedIn" class="d-flex align-items-center">
            ...
            >
              <font-awesome-icon class="icon-user color-blue" icon="fa-solid fa-user" />
            </div>
          </div>
          <div v-else class="d-flex align-items-center">
            <!-- contain switch language and button -->
            <!-- V-if not loggin -->
            <button class="btn-custom btn-blue"><nuxt-link to="/login">Login</nuxt-link></button>
          </div>
